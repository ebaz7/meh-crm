...
const PrintPersonnelDelayForm: React.FC<Props> = ({ delays, date, meta }) => {
    ...
    return (
        <div 
            ...
            style={{ 
                // Locked width to A4 to prevent skewing during scaling
                width: '210mm', 
                minHeight: '297mm',
                direction: 'rtl',
                ...
                fontFamily: 'Vazirmatn, sans-serif', // Ensure font is explicit
                fontVariant: 'normal', // Prevent weird ligatures
                letterSpacing: 'normal' // Prevent stretching
            }}
        >
            <div style={{ border: '2px solid black', height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ display: 'flex', height: '100px', borderBottom: '2px solid black' }}>
                    <div style={{ width: '150px', borderLeft: '2px solid black', padding: '8px', fontSize: '12px', fontWeight: 'bold' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}><span>پیوست:</span><span>........</span></div>
                    </div>
